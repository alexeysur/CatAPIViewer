...
//    private func createBreedDescriptionObjectWith(json: Data, completion: @escaping (_ data: BreedDescription?, _ error: Error?) -> Void) {
//            do {
//                let decoder = JSONDecoder()
//                let imageURL = try decoder.decode(BreedDescription.self, from: json)
//                return completion(imageURL, nil)
//            } catch let error {
//                print("Error creating image of breed from JSON because: \(error.localizedDescription)")
//                return completion(nil, error)
//            }
//    }
